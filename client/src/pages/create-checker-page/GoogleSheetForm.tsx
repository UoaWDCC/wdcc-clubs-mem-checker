...
const GoogleSheetForm = ({ onNext, showInstructions, hasShowedInstructions }: GoogleSheetFormProps) => {
  ...
  return (
    <div className={styles.container}>
      {instructionPageBool ?
      (<div style={{display: "flex", flexDirection: "column", rowGap: "10vh", alignItems: "center"}}>
        <div>
        ...
        <div style={{display: "flex", width: "100%", flexDirection: "row"}}>
          ...
          <div style={{display: "flex", width: "50%", flexDirection: "column", rowGap: "20%", textAlign: "left", marginLeft: "5%"}}>
            ...
            <p className={styles.blueParagraphText}>share with this email: <b>wdcc-membership-checker@membership-checker.iam.gserviceaccount.com</b></p>
