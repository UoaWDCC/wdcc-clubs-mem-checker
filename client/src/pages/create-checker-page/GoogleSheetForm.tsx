...
const GoogleSheetForm = ({
  onNext,
  showInstructions,
  hasShowedInstructions,
}: GoogleSheetFormProps) => {
  const [instructionPageBool, setInstructionPageBool] = useState(
    hasShowedInstructions
  );
        ...
        >
          <div>
            ...
            <i className={styles.subtitle}>
              paste the link to the google sheet with {clubDetails.clubAcronym}
              's membership data
            </i>
          </div>
          ...
          <div>
            <p style={{ fontSize: "14px", color: "#707070" }}>
              ...
              you can create more membership checker pages for your club later
