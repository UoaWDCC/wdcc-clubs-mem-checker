...
interface CustomiseConfirmEditProps {
  onNext: () => void;
  onBack: () => void;
  clubDetails: IClubDetails;
}

const CustomiseConfirmEdit = ({
  onNext,
  onBack,
  clubDetails,
}: CustomiseConfirmEditProps) => {
  ...
  function handleNext(): void {
    ...
    if (page.webLink) formData.append('webLink', page.webLink);
    ...
    formData.append('textFieldBackgroundColor', page.textFieldBackgroundColor!);
    ...
    if (page.dropDownBackgroundColor)
      formData.append('dropDownBackgroundColor', page.dropDownBackgroundColor);
    console.log('confirm:' + page.dropDownBackgroundColor);
    axios
      .post('/pages/edit', formData)
      .then((res) => {
        navigate('/confirmation', {
          state: { pathId: page.webLink!, clubDetails: clubDetails },
        });
      })
      .catch((err) => {
        setIsLoading(false);
...
export default CustomiseConfirmEdit;
